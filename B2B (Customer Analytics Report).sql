...
-- Did the number of customers increase?
SELECT 
...
-- Customers who have done transaction
SELECT 
    QUARTER(createdate) quarter,
    COUNT(DISTINCT customerid) total_customers
FROM
...
-- The best seller of product category in Q1 and Q2
SELECT 
...
-- How many active customers still have transactions?
SELECT 
